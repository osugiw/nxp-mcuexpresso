...
//  - Provides "patch" versions of the aeabi integer divide functions, which
//    vector integer divides onto the ROM divide functions contained in
//    specific NXP MCUs, to replace the standard ones pulled in from the C
//    library

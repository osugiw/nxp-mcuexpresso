...
#define BOARD_INITPINS_LED_STB_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPINS_LED_STB_GPIO_PIN_MASK (1U << 19U) /*!<@brief GPIO pin mask */
#define BOARD_INITPINS_LED_STB_PORT 0U                   /*!<@brief PORT device index: 0 */
#define BOARD_INITPINS_LED_STB_PIN 19U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_LED_STB_PIN_MASK (1U << 19U)      /*!<@brief PORT pin mask */
                                                         /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_LED_CLK_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPINS_LED_CLK_GPIO_PIN_MASK (1U << 11U) /*!<@brief GPIO pin mask */
#define BOARD_INITPINS_LED_CLK_PORT 0U                   /*!<@brief PORT device index: 0 */
#define BOARD_INITPINS_LED_CLK_PIN 11U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_LED_CLK_PIN_MASK (1U << 11U)      /*!<@brief PORT pin mask */
                                                         /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_LED_DIO_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPINS_LED_DIO_GPIO_PIN_MASK (1U << 13U) /*!<@brief GPIO pin mask */
#define BOARD_INITPINS_LED_DIO_PORT 0U                   /*!<@brief PORT device index: 0 */
#define BOARD_INITPINS_LED_DIO_PIN 13U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_LED_DIO_PIN_MASK (1U << 13U)      /*!<@brief PORT pin mask */
                                                         /* @} */

...
board: LPCXpresso804
pin_labels:
- {pin_num: '10', pin_signal: PIO0_11/ADC_6/WKTCLKIN, label: 'CN6[10]/CN8[3]/D4/PIO0_11/M_PIO0_11', identifier: LED_BLUE;LED_CLK}
- {pin_num: '4', pin_signal: PIO0_13/ADC_10, label: 'S1/CN8[4]/CN6[4]/D2/M_PIO0_13/PIO0_13', identifier: LED_RED;S1;LED_DIO}
- {pin_num: '24', pin_signal: PIO0_19/DACOUT, label: 'CN7[1]/CN8[2]/PIO0_19', identifier: LED_STB}
...
- pin_list:
  - {pin_num: '24', peripheral: GPIO, signal: 'PIO0, 19', pin_signal: PIO0_19/DACOUT, direction: OUTPUT, gpio_init_state: 'false', mode: no_init}
  - {pin_num: '10', peripheral: GPIO, signal: 'PIO0, 11', pin_signal: PIO0_11/ADC_6/WKTCLKIN, identifier: LED_CLK, direction: OUTPUT, mode: no_init}
  - {pin_num: '4', peripheral: GPIO, signal: 'PIO0, 13', pin_signal: PIO0_13/ADC_10, identifier: LED_DIO, direction: OUTPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t LED_CLK_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U,
    };
    /* Initialize GPIO functionality on pin PIO0_11 (pin 10)  */
    GPIO_PinInit(BOARD_INITPINS_LED_CLK_GPIO, BOARD_INITPINS_LED_CLK_PORT, BOARD_INITPINS_LED_CLK_PIN, &LED_CLK_config);

    gpio_pin_config_t LED_DIO_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U,
    };
    /* Initialize GPIO functionality on pin PIO0_13 (pin 4)  */
    GPIO_PinInit(BOARD_INITPINS_LED_DIO_GPIO, BOARD_INITPINS_LED_DIO_PORT, BOARD_INITPINS_LED_DIO_PIN, &LED_DIO_config);

    gpio_pin_config_t LED_STB_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U,
    };
    /* Initialize GPIO functionality on pin PIO0_19 (pin 24)  */
    GPIO_PinInit(BOARD_INITPINS_LED_STB_GPIO, BOARD_INITPINS_LED_STB_PORT, BOARD_INITPINS_LED_STB_PIN, &LED_STB_config);
}
...
- pin_list:
  - {pin_num: '10', peripheral: GPIO, signal: 'PIO0, 11', pin_signal: PIO0_11/ADC_6/WKTCLKIN, identifier: LED_BLUE, direction: OUTPUT, gpio_init_state: 'true', mode: inactive,
